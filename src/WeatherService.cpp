...
WeatherData WeatherService::GetData()
{
  ...
  std::string requestSite("http://api.openweathermap.org");
  std::string requestURL("data/2.5/weather?zip=92399,us");
  std::string requestArg("&APPID=e7d28320794a5994c8e10181cee49918");
  ...
  request_stream << "GET " << (requestURL + requestArg).c_str() << " HTTP/1.0\r\n";
